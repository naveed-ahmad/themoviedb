module Tmdb
  class TV < Resource
    ...
    def self.airing_today(conditions = {page: 1})
    ...
    def self.on_the_air(conditions = {page: 1})
    ...
    def self.latest(conditions = {page: 1})
    ...
    # Get the translations for a specific series.
